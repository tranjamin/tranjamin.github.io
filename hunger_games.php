...
<html>
    <head>
        ...
        <title>Benjamin Tran | Member Benefits</title>
...
<!-- TODO: Add SDKs for Firebase products that you want to use
     https://firebase.google.com/docs/web/setup#config-web-app -->
        ...
        <header class='header'>
            ...
            <li><a href="hunger_games.php" style="text-decoration: none; color: white;" id="currentPage" class= "hoverable">Empty Page</a></li>
            <li class="customform">
                    <div class="dropdown">
                            ...
                            <a href="architecture.php">Architecture</a>
                              ...
                              <a href="programming.php">Programming and Robotics</a>
                              <a href="miscellaneous.php">Miscellaneous Miscellanea</a>
                              <a href="member_benefits.php" id="member-benefits">Member Benefits</a>
                            </div>
                    </div>
            </li>
            <li>
